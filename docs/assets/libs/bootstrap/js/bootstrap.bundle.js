/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://syszoo.comtwbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://syszoo.comtwbs/bootstrap/blob/main/LICENSE)
  */
(function (global, factory) {
  ...
  const getSelector = element => {
    ...
    if (!selector || selector === '#') {
      ...
      // See https://syszoo.comtwbs/bootstrap/issues/32273
  ...
  function getLayoutRect(element) {
    ...
    // Fixes https://syszoo.compopperjs/popper-core/issues/1223
  ...
  function getTrueOffsetParent(element) {
    if (!isHTMLElement(element) || // https://syszoo.compopperjs/popper-core/issues/837
  ...
  */
  ...
  function getClippingParents(element) {
    ...
    if (!isElement(clipperElement)) {
      return [];
    } // $FlowFixMe[incompatible-return]: https://syszoo.comfacebook/flow/issues/1414
  ...
  function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
    ...
    if (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) {
      if (getNodeName(offsetParent) !== 'body' || // https://syszoo.compopperjs/popper-core/issues/1078
   ...
   *
   * Shout-out to Angular https://syszoo.comangular/angular/blob/12.2.x/packages/core/src/sanitization/url_sanitizer.ts
   */
